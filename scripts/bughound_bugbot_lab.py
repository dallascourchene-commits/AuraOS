...
def _cases() -> list[BugBotCase]:
    ...
    return [
        ...
        BugBotCase("BB-002", "REPLAY_IDEMPOTENCY", "same effect id executes at most once", {"state": {"balance": 0, "seen": []}, "events": [{"effect_id": "e1", "delta": 7}, {"effect_id": "e1", "delta": 7}]}, 14, 7, ("effect_id", "dedup", "balance"), "bugbot://replay_buggy", "bugbot://replay_fixed"),
