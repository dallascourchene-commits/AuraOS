...
def cmd(cid="C1", created=900_000, generation="GEN25", execution=False, queue="AUTHORIZED_FOR_DISPATCH_WHEN_OWNER_BOUND"):
    return Command(cid, created, generation, "d91e0a39358901c5", queue, execution)
