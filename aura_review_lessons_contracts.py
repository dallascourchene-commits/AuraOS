...
_MAX_PERSISTED_FINDINGS = 500
_MAX_FINDINGS_FILE_BYTES = 8_388_608
_MAX_STORED_FINDING_BYTES = 32_768
...
_PROTECTED_AUTHORITY_EXPECTED = {
    key: False for key in _PROTECTED_AUTHORITY_KEYS
}
_PROTECTED_AUTHORITY_EXPECTED.update(
    {
