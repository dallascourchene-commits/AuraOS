...
_FILE_ROWS = (
    ...
    ("aura_planning_board.py", FileRole.CANONICAL_CONTRACT, ("P2.1", "P7", "P8"), "f60d49ef5fa35eff6f9042ebeab7a2604ebb3a0c", ("GoalSpec", "ActionSpec", "PlanningBoard", "verify_board_continuity"), (("PLANNING_BOARD_VERSION", "AURA_PLANNING_BOARD_V1"),)),
    ...
    ("aura_qdkt_observations.py", FileRole.CANONICAL_CONTRACT, ("P6.1",), "c425be6515727f4e382c1b26adf973d823a1521b", ("QDKTObservation", "QDKTTruthClass"), (("QDKT_EVENT_VERSION", "AURA_QDKT_EVENTS_P6_1"), ("QDKT_GENERATOR_VERSION", "QUANTUM_MERKLE_DAG_V1"))),
