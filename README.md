...
| LLM orchestration | Calibrates providers, routes tasks by quality/cost, logs token and dollar savings, and runs AuraFusion panel-plus-judge deliberation. |
| Research ingestion | Forages arXiv, searches ingested papers with VSA structure, gates synthesis through SkillWeaver, and stages grounded code mutations. |
