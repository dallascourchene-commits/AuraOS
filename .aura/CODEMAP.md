...
- **file_count**: 1083
- **total_bytes**: 51296932
- **text_tokens_est**: 3427205
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 27, 'knowledge_artifact': 138, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 718, 'schema_or_lexicon': 102, 'support_file': 83}
- **topology_nodes**: 8402
- **topology_edges**: 18428
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 18132.95

## Coverage

- **included_file_count**: 1083
...
- **skipped_dir_file_counts**: `.git`=61, `Aura_Memory`=6, `Aura_Sandbox`=1, `__pycache__`=8
...
- ... 912 more; query CODEMAP.json for exact file cards
...
- `aura_relational_authority.py` (python_module): 58 symbols, degree 476, ~19006 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_relational_authority.py` degree=476 nodes=59 neighbors=`aura_civic_planning.py`, `aura_workflow_gates.py`, `liquid_attractor_control_plane.py`
