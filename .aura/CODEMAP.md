...
- **file_count**: 1554
- **total_bytes**: 58616113
- **text_tokens_est**: 5197328
...
- **topology_nodes**: 11271
- **topology_edges**: 27226
...
- **skipped_dir_file_counts**: `.git`=221, `Aura_Memory`=6, `Aura_Sandbox`=2, `__pycache__`=8
...
- `aura_relational_index.py` (python_module): 75 symbols, degree 455, ~25891 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_relational_index.py` degree=455 nodes=81 neighbors=`aura_capability_connectome.py`, `aura_capability_connectome_v2.py`, `aura_codebase_navigator.py`, `aura_coding_relationship_compass.py`
