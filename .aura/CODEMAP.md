...
- **file_count**: 1655
- **total_bytes**: 26565049
- **text_tokens_est**: 6631618
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1007, 'schema_or_lexicon': 277, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-o65-authority-materialization-proposal-conformance.yml",
    ...
    "tests/test_aura_materialization_support_lifecycle_lineage.py",
    ...
    "tests/test_aura_pre_attempt_lifecycle_lineage.py",
    ...
    "tests/test_aura_q22_materialization_support_lifecycle.py",
