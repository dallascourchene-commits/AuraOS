...
- **file_count**: 1446
- **total_bytes**: 57197721
- **text_tokens_est**: 4847155
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 51, 'knowledge_artifact': 185, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 932, 'schema_or_lexicon': 185, 'support_file': 77}
- **topology_nodes**: 10710
- **topology_edges**: 25526
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 32293.84

## Coverage

- **included_file_count**: 1446
...
- ... 1229 more; query CODEMAP.json for exact file cards
...
- `aura_relationship_contracts.py` (python_module): 89 symbols, degree 729, ~21820 tokens
...
- `aura_architect_loop.py` (python_module): 70 symbols, degree 466, ~20337 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_relationship_contracts.py` degree=729 nodes=91 neighbors=`aura_arena_architect_connector.py`, `aura_coding_relationship_compass.py`, `aura_coding_waboose_breadboard.py`, `aura_planning_board.py`
  ...
  - `aura_architect_loop.py` degree=466 nodes=73 neighbors=`aura_arena_architect_connector.py`, `aura_arena_st3gg_codec.py`, `aura_codebase_navigator.py`, `aura_construction_architect_refactor.py`
...
- `ArchitectExecutionResult` -> `aura_architect_loop.py:308`
- `ArchitectFusionCouncil` -> `aura_live_architect.py:996`
- `ArchitectFusionLoop` -> `aura_architect_loop.py:1930`
- `ArchitectLedgerRecord` -> `aura_architect_loop.py:275`
- `ArchitectLoopResult` -> `aura_architect_loop.py:290`
- `ArchitectModelProfile` -> `aura_live_architect.py:115`
- `ArchitectModelRouter` -> `aura_live_architect.py:672`
- `ArchitectureComponent` -> `aura_coding_relationship_compass.py:160`
...
- `ArenaPatch` -> `aura_architect_loop.py:228`
