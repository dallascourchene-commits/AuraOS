...
- **file_count**: 1724
- **total_bytes**: 26966216
- **text_tokens_est**: 6731934
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 244, 'native_accelerator': 40, 'operator_script': 9, 'python_module': 1005, 'schema_or_lexicon': 313, 'support_file': 49}
...
```json
{
  ...
  "roles": {
    ...
    "native_accelerator": 40,
    "operator_script": 9,
    "python_module": 1005,
    "schema_or_lexicon": 313,
    "support_file": 49
  }
}
```
