...
- **file_count**: 1002
- **total_bytes**: 50695956
- **text_tokens_est**: 3277707
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 133, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 699, 'schema_or_lexicon': 100, 'support_file': 42}
- **topology_nodes**: 8205
- **topology_edges**: 17892
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 19378.48

## Coverage

- **included_file_count**: 1002
...
- ... 832 more; query CODEMAP.json for exact file cards
...
- `aura_human_agent_arena.py` (python_module): 72 symbols, degree 328, ~22286 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_human_agent_arena.py` degree=328 nodes=73 neighbors=`aura_affordance_directory.py`, `aura_agent_arena_bridge.py`, `aura_api_rotator.py`, `aura_coding_arena_3d.py`
