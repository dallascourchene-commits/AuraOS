...
- **file_count**: 1651
- **total_bytes**: 26548060
- **text_tokens_est**: 6627371
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1009, 'schema_or_lexicon': 271, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/test_triadic_artifact_rebase.py",
    "tools/arena/triadic_artifact_rebase.py",
