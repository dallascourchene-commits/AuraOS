...
- **file_count**: 1653
- **total_bytes**: 26509229
- **text_tokens_est**: 6617649
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_12_airllm_security_reproof_dag/README.md",
    "tools/arena/worker_cells/agent_12_airllm_security_reproof_dag/airllm_security_reproof_dag.py",
    "tools/arena/worker_cells/agent_12_airllm_security_reproof_dag/campaign.py",
    "tools/arena/worker_cells/agent_12_airllm_security_reproof_dag/test_airllm_security_reproof_dag.py",
