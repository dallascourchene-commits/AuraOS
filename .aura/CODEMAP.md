...
- **file_count**: 1287
- **total_bytes**: 54901556
- **text_tokens_est**: 4286700
...
- **topology_nodes**: 10023
- **topology_edges**: 22982
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 545, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=545 nodes=36 neighbors=`aura_architect_loop.py`, `aura_external_llm_session.py`, `aura_fusion.py`, `aura_gate.py`
