...
- **file_count**: 1649
- **total_bytes**: 26513078
- **text_tokens_est**: 6618624
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1005, 'schema_or_lexicon': 273, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-awj032-lifecycle-return-memory-evidence.yml",
    ...
    "scripts/aura_awj032_lifecycle_return_memory_evidence.py",
    ...
    "tests/test_aura_awj032_lifecycle_return_memory_evidence.py",
