...
- **file_count**: 1643
- **total_bytes**: 26437933
- **text_tokens_est**: 6599835
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-cross-city-bridge.yml",
    ...
    "05_staging/aura_cross_city_bridge/README.md",
    "05_staging/aura_cross_city_bridge/cross_city_bridge.py",
    "05_staging/aura_cross_city_bridge/test_cross_city_bridge.py",
