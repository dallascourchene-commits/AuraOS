...
- **file_count**: 1729
- **total_bytes**: 27031537
- **text_tokens_est**: 6748267
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 244, 'native_accelerator': 39, 'operator_script': 9, 'python_module': 1014, 'schema_or_lexicon': 310, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/k27-projection-format-diagnostic.yml",
    ...
    "scripts/aura_workcapsule_canonical_projection_scoped_rebind.py",
...
```json
{
  ...
  "roles": {
    ...
    "native_accelerator": 39,
    "operator_script": 9,
    "python_module": 1014,
    "schema_or_lexicon": 310,
    "support_file": 49
  }
}
```
