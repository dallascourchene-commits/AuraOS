...
- **file_count**: 1554
- **total_bytes**: 58810663
- **text_tokens_est**: 5245965
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 64, 'knowledge_artifact': 196, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 973, 'schema_or_lexicon': 226, 'support_file': 79}
- **topology_nodes**: 11300
- **topology_edges**: 27389
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 35081.3

## Coverage

- **included_file_count**: 1554
...
- **skipped_dir_file_counts**: `.git`=244, `Aura_Memory`=6, `Aura_Sandbox`=2, `__pycache__`=8
...
- ... 1331 more; query CODEMAP.json for exact file cards
...
- `aura_ephemeral_workspace_contracts.py` (python_module): 88 symbols, degree 654, ~27454 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_ephemeral_workspace_contracts.py` degree=654 nodes=89 neighbors=`aura_coding_relationship_compass.py`, `aura_ephemeral_path_policy.py`, `aura_llm_egress.py`, `aura_spatial_projection.py`
