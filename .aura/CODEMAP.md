...
- **file_count**: 1664
- **total_bytes**: 26624719
- **text_tokens_est**: 6646536
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 17, 'operator_script': 9, 'python_module': 1005, 'schema_or_lexicon': 281, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/thinkpad-sustained-operating-envelope.yml",
