...
- **file_count**: 1650
- **total_bytes**: 26503945
- **text_tokens_est**: 6616343
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-execution-aware-hyperscale-admission.yml",
    ".github/workflows/aura-execution-qualified-portable-semantic-evidence.yml",
    ".github/workflows/aura-hyperscale-work-admission.yml",
    ...
    "tests/test_aura_execution_qualified_portable_semantic_evidence.py",
    ...
    "tests/test_aura_hyperscale_work_admission.py",
    ...
    "tools/aura_execution_qualified_portable_semantic_evidence.py",
