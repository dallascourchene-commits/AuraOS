...
- **file_count**: 1554
- **total_bytes**: 58789041
- **text_tokens_est**: 5240559
...
- `aura_ephemeral_workspace_contracts.py` (python_module): 86 symbols, degree 632, ~26335 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_ephemeral_workspace_contracts.py` degree=632 nodes=87 neighbors=`aura_coding_relationship_compass.py`, `aura_ephemeral_path_policy.py`, `aura_llm_egress.py`, `aura_spatial_projection.py`
