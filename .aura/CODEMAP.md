...
- **file_count**: 1661
- **total_bytes**: 26593908
- **text_tokens_est**: 6638836
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1015, 'schema_or_lexicon': 275, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "scripts/aura_awj032_storage_envelope_common_cut_gap.py",
    ...
    "tests/test_aura_awj032_storage_envelope_common_cut_gap.py",
    ...
    "tools/test_thinkpad_sustained_operating_envelope.py",
