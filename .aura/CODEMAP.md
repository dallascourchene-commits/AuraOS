...
- **file_count**: 1705
- **total_bytes**: 26950885
- **text_tokens_est**: 6728093
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1033, 'schema_or_lexicon': 292, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-raw-owner-stale-safe-reentry.yml",
    ...
    ".github/workflows/aura-workcapsule-scoped-post-repair-rebind.yml",
    ...
    ".github/workflows/workcapsule-post-world-bound-scoped-rebind-exact.yml",
    ".gitignore",
