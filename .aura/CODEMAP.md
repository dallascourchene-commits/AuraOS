...
- **file_count**: 1748
- **total_bytes**: 27338013
- **text_tokens_est**: 6824889
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1062, 'schema_or_lexicon': 306, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-proof-type-memory-admission.yml",
    ...
    "scripts/aura_workcapsule_proof_type_memory_admission.py",
    ...
    "tests/test_aura_workcapsule_proof_type_memory_admission.py",
