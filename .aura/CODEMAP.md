...
- **file_count**: 1657
- **total_bytes**: 26530713
- **text_tokens_est**: 6623031
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-eki-subject-version-resolver-proof.yml",
    ...
    "tests/test_aura_external_cognition_subject_version_resolver.py",
