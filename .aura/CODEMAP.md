...
- **file_count**: 1651
- **total_bytes**: 26519153
- **text_tokens_est**: 6620142
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 238, 'native_accelerator': 14, 'operator_script': 9, 'python_module': 1001, 'schema_or_lexicon': 276, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/k27-astge-native-reference-conformance.yml",
    ...
    "crates/aura-k27-astge/src/bin/reference_conformance.rs",
