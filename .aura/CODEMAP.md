...
- **file_count**: 1650
- **total_bytes**: 26478741
- **text_tokens_est**: 6610040
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1003, 'schema_or_lexicon': 273, 'support_file': 50}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".aura/arena/objective-h-proof-activation.txt",
    ...
    ".github/workflows/aura-objective-h-hosted-proof-mirror.yml",
    ...
    "tests/test_aura_fractal_k27.py",
