...
- **file_count**: 588
- **total_bytes**: 60039938
- **text_tokens_est**: 5411665
...
- **elapsed_ms**: 24549.18
- **last_incremental_refresh_unix**: 1783810484
...
- **skipped_dir_file_counts**: `.git`=48, `.pytest_cache`=4, `Aura_Memory`=0, `__pycache__`=128
...
- `aura_node.py` (python_module): 80 symbols, degree 0, ~104110 tokens
- `aura_agent_arena_cli.py` (python_module): 80 symbols, degree 0, ~17235 tokens
- `test_scientific_memory.py` (python_module): 80 symbols, degree 0, ~13607 tokens
- `tests/test_aura_emergent_result_verifier.py` (python_module): 80 symbols, degree 0, ~11348 tokens
- `test_aura_functions.py` (python_module): 80 symbols, degree 0, ~9340 tokens
- `tests/test_aura_civic_commons_arena.py` (python_module): 80 symbols, degree 0, ~5681 tokens
- `test_aura_ojibwe_tutor.py` (python_module): 77 symbols, degree 0, ~7492 tokens
- `aura_live_architect.py` (python_module): 74 symbols, degree 0, ~30294 tokens
- `aura_human_agent_arena.py` (python_module): 72 symbols, degree 0, ~22286 tokens
- `aura_architect_loop.py` (python_module): 70 symbols, degree 0, ~18332 tokens
- `tests/test_aura_hermes_arena_mode.py` (python_module): 66 symbols, degree 0, ~7466 tokens
- `aura_topological_context_anchor.py` (python_module): 64 symbols, degree 0, ~10851 tokens
