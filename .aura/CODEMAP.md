...
- **file_count**: 634
- **total_bytes**: 59996761
- **text_tokens_est**: 5642031
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 7, 'knowledge_artifact': 85, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 467, 'schema_or_lexicon': 32, 'support_file': 28}
- **topology_nodes**: 6274
...
- **skipped_dir_file_counts**: `.git`=37, `Aura_Memory`=1, `__pycache__`=8
...
- `!ai_router_regen` -> `USER_GUIDE.md:860`, `aura_node.py:7217`
- `!approve` -> `AURA_FINAL_REPORT.md:151`, `USER_GUIDE.md:897`, `aura_node.py:5638`
- `!ar_server_start` -> `USER_GUIDE.md:930`, `aura_node.py:6588`
- `!ar_server_stop` -> `USER_GUIDE.md:931`, `aura_node.py:6604`
- `!ar_start` -> `AURA_FINAL_REPORT.md:168`, `USER_GUIDE.md:930`, `aura_node.py:6588`, `refactored-auraos-upgrades.md:2572`
- `!ar_stop` -> `AURA_FINAL_REPORT.md:169`, `USER_GUIDE.md:931`, `aura_node.py:6604`, `refactored-auraos-upgrades.md:2572`
- `!attention` -> `USER_GUIDE.md:866`, `aura_node.py:5686`
- `!audit` -> `USER_GUIDE.md:881`, `aura_node.py:6184`
- `!backtrack` -> `AURA_FINAL_REPORT.md:143`, `USER_GUIDE.md:905`, `arxiv_forager.py:657`, `aura_node.py:6204`
- `!benchmark` -> `USER_GUIDE.md:880`, `aura_node.py:2991`
- `!c` -> `arch_reasoner_accel.rs:14`
- `!calibrate` -> `AURA_FINAL_REPORT.md:163`, `USER_GUIDE.md:920`, `aura_node.py:7532`
- `!canvas` -> `aura_savings_dashboard.py:174`
- `!catalyze` -> `AURA_FINAL_REPORT.md:156`, `USER_GUIDE.md:898`, `aura_node.py:7239`, `generate_ai_router.py:356`
- `!codeExts` -> `CODEMAP_TOOL_INTEGRATION_GUIDE.md:506`
- `!cognitive_search` -> `USER_GUIDE.md:865`, `aura_node.py:5655`
- `!commands` -> `USER_GUIDE.md:205`
- `!contingency_spawn` -> `aura_node.py:7006`
- `!converse` -> `AURA_FINAL_REPORT.md:161`, `USER_GUIDE.md:921`, `aura_node.py:7649`
- `!coordinated_reason` -> `USER_GUIDE.md:873`, `aura_node.py:7449`
- `!crystallize` -> `AURA_FINAL_REPORT.md:141`, `USER_GUIDE.md:911`, `aura_node.py:7306`
- `!curiosity_tree` -> `AURA_FINAL_REPORT.md:174`, `USER_GUIDE.md:909`, `aura_node.py:6645`
- `!db_repair` -> `USER_GUIDE.md:934`, `aura_node.py:2991`
- `!doctype` -> `aura_coding_arena/index.html:1`, `aura_efficiency_report.py:124`, `aura_human_agent_arena/index.html:1`
- `!empirical_lab` -> `USER_GUIDE.md:890`, `aura_node.py:6230`
- `!evolve_reasoning` -> `AURA_FINAL_REPORT.md:157`, `USER_GUIDE.md:875`, `aura_node.py:7301`
- `!export` -> `USER_GUIDE.md:932`, `aura_node.py:6008`
- `!fast_path` -> `AURA_FINAL_REPORT.md:173`, `USER_GUIDE.md:864`, `aura_node.py:7391`, `test_aura_functions.py:927`
- `!forage` -> `USER_GUIDE.md:904`, `aura_affordance_directory.py:461`, `aura_capability_lane_registry.py:120`, `aura_node.py:6190`
- `!forage_off` -> `USER_GUIDE.md:910`, `aura_node.py:6582`
- `!forage_on` -> `USER_GUIDE.md:910`, `aura_node.py:6576`
- `!forager_off` -> `aura_node.py:6582`
- `!forager_on` -> `aura_node.py:6576`
- `!fusion` -> `AURA_FINAL_REPORT.md:31`, `USER_GUIDE.md:919`, `aura_fusion.py:384`, `aura_node.py:7518`
- `!heal` -> `aura_node.py:5209`
- `!help` -> `AURA_FINAL_REPORT.md:48`, `SYNTAX_FIXES_APPLIED.md:107`, `USER_GUIDE.md:858`, `aura_node.py:7668`
...
- `!manifest` -> `AURA_FINAL_REPORT.md:138`, `USER_GUIDE.md:858`, `aura_node.py:7668`
- `!markov` -> `AURA_FINAL_REPORT.md:144`, `USER_GUIDE.md:935`, `aura_node.py:7504`
- `!mesh_status` -> `AURA_FINAL_REPORT.md:167`, `USER_GUIDE.md:923`, `aura_capability_lane_registry.py:158`, `aura_node.py:5649`
- `!meta_analyze` -> `USER_GUIDE.md:876`, `aura_node.py:7352`
- `!meta_reason` -> `AURA_FINAL_REPORT.md:155`, `USER_GUIDE.md:877`, `aura_arch_reasoner.py:93`, `aura_node.py:7377`
- `!optimize` -> `AURA_FINAL_REPORT.md:172`, `USER_GUIDE.md:892`, `aura_node.py:5931`
- `!ping_mesh` -> `AURA_FINAL_REPORT.md:166`, `USER_GUIDE.md:924`, `aura_capability_lane_registry.py:158`, `aura_node.py:5644`
- `!plan` -> `aura_affordance_directory.py:440`, `aura_node.py:5602`
- `!push` -> `USER_GUIDE.md:933`, `aura_node.py:5166`, `test_aura_functions.py:207`
- `!qdkt` -> `aura_affordance_directory.py:356`
- `!r` -> `aura_arena_wfst_compiler.py:181`, `aura_ephemeral_adapter_registry.py:134`, `aura_graphify_schema.py:160`, `aura_hv_cache.py:373`
- `!reason` -> `AURA_FINAL_REPORT.md:154`, `USER_GUIDE.md:872`, `aura_node.py:7492`
- `!repair_db` -> `USER_GUIDE.md:934`, `aura_node.py:6979`
- `!research` -> `AURA_FINAL_REPORT.md:142`, `USER_GUIDE.md:906`, `aura_affordance_directory.py:461`, `aura_capability_lane_registry.py:120`
- `!review` -> `USER_GUIDE.md:893`, `aura_node.py:6709`, `mistral_gate.py:93`
- `!rollback` -> `USER_GUIDE.md:896`, `aura_node.py:6694`
- `!route` -> `AURA_FINAL_REPORT.md:28`, `AURA_ROUTER.md:213`, `USER_GUIDE.md:918`, `aura_affordance_directory.py:230`
- `!s` -> `async_palace.py:163`, `aura_mitosis.py:196`, `aura_node.py:1167`, `aura_spvm.py:134`
- `!saturn` -> `AURA_FINAL_REPORT.md:147`, `AuraOS.tex:212`, `Second_Paper_extracted.txt:74`, `USER_GUIDE.md:878`
- `!saturn_heal` -> `AURA_FINAL_REPORT.md:148`, `AURA_REFACTORING_ANALYSIS.md:136`, `HOLOGRAPHIC_HEADER_IMPLEMENTATION.md:121`, `USER_GUIDE.md:879`
- `!savings` -> `AURA_FINAL_REPORT.md:162`, `AuraOS.tex:185`, `USER_GUIDE.md:922`, `aura_node.py:7556`
- `!scan_topology` -> `USER_GUIDE.md:861`, `aura_node.py:7148`
- `!search_similar` -> `USER_GUIDE.md:907`, `aura_node.py:6618`, `refactored-auraos-upgrades.md:2573`
- `!self_optimize` -> `USER_GUIDE.md:892`, `aura_dynamic_attention.py:209`, `aura_node.py:5931`, `refactored-auraos-upgrades.md:826`
- `!self_reflect` -> `USER_GUIDE.md:891`, `aura_arch_reasoner.py:223`, `aura_hv_cache.py:36`, `aura_node.py:5749`
- `!settings` -> `USER_GUIDE.md:858`, `aura_node.py:7668`
- `!show` -> `docs/AURA_HUMAN_AGENT_ARENA.md:267`, `tests/test_aura_human_agent_concepts.py:86`
- `!simulate` -> `USER_GUIDE.md:863`, `aura_node.py:7142`, `cognitive_router.py:224`
- `!something` -> `aura_node.py:4969`
- `!srcPos` -> `index.html:122`
- `!stage` -> `AURA_FINAL_REPORT.md:149`, `USER_GUIDE.md:893`, `aura_capability_lane_registry.py:229`, `aura_live_architect.py:2159`
- `!stage_merge` -> `AURA_FINAL_REPORT.md:150`, `USER_GUIDE.md:894`, `aura_capability_lane_registry.py:229`, `aura_live_architect.py:2160`
- `!stage_purge` -> `USER_GUIDE.md:895`, `aura_capability_lane_registry.py:229`, `aura_node.py:6774`
- `!stage_review` -> `USER_GUIDE.md:893`, `aura_capability_lane_registry.py:229`, `aura_node.py:6709`
- `!status` -> `AURA_FINAL_REPORT.md:136`, `SYNTAX_FIXES_APPLIED.md:107`, `aura_node.py:5166`
- `!strategy_buffer_stats` -> `USER_GUIDE.md:874`, `aura_coordinated_solver.py:69`, `aura_node.py:7476`
...
- `!topology` -> `AURA_FINAL_REPORT.md:48`, `SYNTAX_FIXES_APPLIED.md:107`, `USER_GUIDE.md:861`, `aura_affordance_directory.py:146`
- `!topology_deep` -> `USER_GUIDE.md:862`, `aura_affordance_directory.py:146`, `aura_node.py:7231`
- `!total` -> `aura_savings_dashboard.py:223`
- `!voice` -> `USER_GUIDE.md:936`, `aura_node.py:7731`
...
- ... 24 more; query CODEMAP.json for exact file cards
...
- ... 512 more; query CODEMAP.json for exact file cards

## Hubs

- `aura_node.py` (python_module): 194 symbols, degree 869, ~104110 tokens
- `aura_agent_arena_cli.py` (python_module): 100 symbols, degree 575, ~17235 tokens
- `aura_live_architect.py` (python_module): 74 symbols, degree 531, ~30294 tokens
- `test_scientific_memory.py` (python_module): 111 symbols, degree 517, ~13607 tokens
- `aura_architect_loop.py` (python_module): 70 symbols, degree 471, ~18332 tokens
- `aura_fst_routing.py` (python_module): 35 symbols, degree 426, ~8991 tokens
...
- `aura_music_coding_arena.py` (python_module): 46 symbols, degree 306, ~11812 tokens
- `aura_topological_context_anchor.py` (python_module): 64 symbols, degree 279, ~10851 tokens
- `aura_understand_graph_bridge.py` (python_module): 64 symbols, degree 270, ~9078 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_architect_loop.py` degree=471 nodes=73 neighbors=`aura_arena_experience_ledger.py`, `aura_arena_st3gg_codec.py`, `aura_codebase_navigator.py`, `aura_dream_retrieval.py`
  - `aura_fst_routing.py` degree=426 nodes=36 neighbors=`aura_architect_loop.py`, `aura_fusion.py`, `aura_graphify_schema.py`, `aura_harness_evolver.py`
  ...
  - `aura_understand_graph_bridge.py` degree=270 nodes=65 neighbors=`aura_cost_telemetry_events.py`, `aura_fst_routing.py`, `aura_ojibwe_dialect_conflict_resolver.py`, `aura_qdkt.py`
...
- `ArenaExperience` -> `aura_arena_experience.py:55`
- `ArenaExperienceLedger` -> `aura_arena_experience_ledger.py:30`
