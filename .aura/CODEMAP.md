...
- **file_count**: 1672
- **total_bytes**: 26678621
- **text_tokens_est**: 6660006
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 240, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1024, 'schema_or_lexicon': 274, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/airllm-finite-json-timeout-repair.yml",
    ...
    "setup_aura.sh",
    "spatial_mapper.py",
    "src/auraos/security/README_airllm_generation_bound_json_service.md",
    "src/auraos/security/airllm_generation_bound_json_service.py",
    "src/auraos/security/airllm_isolated_native_service.py",
    "src/auraos/security/airllm_json_process_isolation.py",
    ...
    "src/auraos/security/campaign_airllm_generation_bound_json_service.py",
    "src/auraos/security/campaign_airllm_process_isolation.py",
    "src/auraos/security/test_airllm_custom_generate_denial.py",
    "src/auraos/security/test_airllm_generation_bound_json_service.py",
