...
- **file_count**: 819
- **total_bytes**: 63494580
- **text_tokens_est**: 6470148
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 111, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 572, 'schema_or_lexicon': 62, 'support_file': 46}
- **topology_nodes**: 7122
...
- **skipped_dir_file_counts**: `.git`=48, `.pytest_cache`=4, `.ruff_cache`=4, `Aura_Memory`=1, `Aura_Sandbox`=1, `__pycache__`=11
