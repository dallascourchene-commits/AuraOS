...
- **file_count**: 1653
- **total_bytes**: 26520191
- **text_tokens_est**: 6620389
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_11_provider_observation_slice_bridge/README.md",
    "tools/arena/worker_cells/agent_11_provider_observation_slice_bridge/campaign.py",
    "tools/arena/worker_cells/agent_11_provider_observation_slice_bridge/provider_observation_slice_bridge.py",
    "tools/arena/worker_cells/agent_11_provider_observation_slice_bridge/test_provider_observation_slice_bridge.py",
