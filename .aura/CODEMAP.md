...
- **file_count**: 1653
- **total_bytes**: 26503117
- **text_tokens_est**: 6616121
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_04_fused_route_event_contract/README.md",
    "tools/arena/worker_cells/agent_04_fused_route_event_contract/benchmark_fused_route_event_contract.py",
    "tools/arena/worker_cells/agent_04_fused_route_event_contract/fused_route_event_contract.py",
    "tools/arena/worker_cells/agent_04_fused_route_event_contract/test_fused_route_event_contract.py",
