...
- **file_count**: 1644
- **total_bytes**: 26436890
- **text_tokens_est**: 6599574
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-retrieval-progress-guard-exact-reproof.yml",
    ...
    "tests/test_aura_retrieval_progress_guard.py",
