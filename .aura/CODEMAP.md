...
- **file_count**: 913
- **total_bytes**: 65979064
- **text_tokens_est**: 7098724
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 465, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=465 nodes=36 neighbors=`aura_architect_loop.py`, `aura_fusion.py`, `aura_graphify_schema.py`, `aura_harness_evolver.py`
