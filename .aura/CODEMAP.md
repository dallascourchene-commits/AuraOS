...
- **file_count**: 1753
- **total_bytes**: 27385297
- **text_tokens_est**: 6836712
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1066, 'schema_or_lexicon': 307, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-provenance-corroboration-memory-admission.yml",
    ...
    ".github/workflows/aura-workcapsule-corroboration-memory-identity.yml",
    ".github/workflows/aura-workcapsule-corroboration-preserves-evidence-classes.yml",
    ".github/workflows/aura-workcapsule-current-recursive-target-raw-slice.yml",
    ".github/workflows/aura-workcapsule-live-artifact-raw-slice-noninterchangeability.yml",
    ".github/workflows/aura-workcapsule-live-causal-artifact-host-observation.yml",
    ".github/workflows/aura-workcapsule-live-causal-raw-slice-join.yml",
    ...
    ".github/workflows/aura-workcapsule-post-repair-source-projection-continuity.yml",
    ".github/workflows/aura-workcapsule-recursive-portable-current-shared-owner.yml",
    ".github/workflows/aura-workcapsule-reentry-closure-exact-verifier.yml",
    ".github/workflows/aura-workcapsule-reentry-closure.yml",
    ".github/workflows/aura-workcapsule-reentry-exact-verifier.yml",
    ".github/workflows/aura-workcapsule-scoped-portable-target-identity.yml",
    ".github/workflows/aura-workcapsule-selective-reentry.yml",
    ".github/workflows/aura-workcapsule-source-reentry-observation.yml",
    ".github/workflows/aura-workcapsule-stale-exact-observation-owner-reduction.yml",
    ".github/workflows/aura-workcapsule-stale-exact-reentry.yml",
    ".github/workflows/aura-workcapsule-two-phase-observation-bound-exact.yml",
    ".github/workflows/aura-workcapsule-two-phase-owner-reduced-transition.yml",
    ...
    ".github/workflows/workcapsule-scoped-higher-owner-portable-continuity-exact.yml",
    ".gitignore",
    ...
    "scripts/aura_k27_astge_portable_raw_slice_causal_handoff.py",
    ...
    "scripts/aura_workcapsule_artifact_qualified_host_observation.py",
    "scripts/aura_workcapsule_canonical_temporal_lifecycle_equivalence.py",
    "scripts/aura_workcapsule_context_binding.py",
    "scripts/aura_workcapsule_corroboration_memory_identity.py",
    "scripts/aura_workcapsule_corroboration_preserves_evidence_classes.py",
    "scripts/aura_workcapsule_current_recursive_target_raw_slice_binding.py",
    "scripts/aura_workcapsule_exact_hold_to_closed_transition.py",
    "scripts/aura_workcapsule_live_artifact_raw_slice_noninterchangeability.py",
    "scripts/aura_workcapsule_live_causal_artifact_host_observation.py",
    "scripts/aura_workcapsule_live_causal_corroboration.py",
    "scripts/aura_workcapsule_live_causal_raw_slice_join.py",
    "scripts/aura_workcapsule_observation_bound_closure.py",
    "scripts/aura_workcapsule_observation_bound_exact_verifier.py",
    "scripts/aura_workcapsule_post_repair_source_projection_continuity.py",
    "scripts/aura_workcapsule_raw_owner_derived_post_closure_transition.py",
    "scripts/aura_workcapsule_raw_owner_end_to_end_stale_lifecycle.py",
    "scripts/aura_workcapsule_raw_owner_hold_to_closed_transition.py",
    "scripts/aura_workcapsule_raw_owner_stale_safe_reentry.py",
    "scripts/aura_workcapsule_reentry_closure.py",
    "scripts/aura_workcapsule_reentry_closure_exact_verifier.py",
    "scripts/aura_workcapsule_reentry_exact_verifier.py",
    "scripts/aura_workcapsule_reentry_invalidation.py",
    "scripts/aura_workcapsule_scoped_higher_owner_portable_continuity.py",
    "scripts/aura_workcapsule_scoped_portable_target_identity.py",
    "scripts/aura_workcapsule_scoped_post_repair_rebind.py",
    "scripts/aura_workcapsule_source_bound_exact_reentry.py",
    "scripts/aura_workcapsule_source_reentry_observation.py",
    "scripts/aura_workcapsule_stale_exact_observation_owner_reduction.py",
    "scripts/aura_workcapsule_stale_exact_reentry.py",
    "scripts/aura_workcapsule_stale_observation_closure_exact_verifier.py",
    "scripts/aura_workcapsule_two_phase_observation_bound_exact.py",
    "scripts/aura_workcapsule_two_phase_owner_reduced_transition.py",
    "scripts/aura_workcapsule_two_phase_source_bound_closure.py",
    ...
    "tests/fixtures/o29_pr541_portable_higher_owner_vector.json",
    ...
    "tests/test_aura_workcapsule_corroboration_memory_identity.py",
    "tests/test_aura_workcapsule_corroboration_preserves_evidence_classes.py",
    "tests/test_aura_workcapsule_current_recursive_target_raw_slice_binding.py",
    "tests/test_aura_workcapsule_live_artifact_raw_slice_noninterchangeability.py",
    "tests/test_aura_workcapsule_live_causal_artifact_host_observation.py",
    "tests/test_aura_workcapsule_live_causal_corroboration.py",
    "tests/test_aura_workcapsule_live_causal_raw_slice_join.py",
    "tests/test_aura_workcapsule_observation_bound_closure.py",
    "tests/test_aura_workcapsule_observation_bound_exact_verifier.py",
    "tests/test_aura_workcapsule_post_repair_source_projection_continuity.py",
    "tests/test_aura_workcapsule_recursive_portable_current_shared_owner.py",
    "tests/test_aura_workcapsule_reentry_closure.py",
    "tests/test_aura_workcapsule_reentry_closure_exact_verifier.py",
    "tests/test_aura_workcapsule_reentry_exact_verifier.py",
    "tests/test_aura_workcapsule_reentry_invalidation.py",
    "tests/test_aura_workcapsule_scoped_higher_owner_portable_continuity.py",
    "tests/test_aura_workcapsule_scoped_portable_target_identity.py",
    "tests/test_aura_workcapsule_scoped_post_repair_rebind.py",
    "tests/test_aura_workcapsule_source_bound_exact_reentry.py",
    "tests/test_aura_workcapsule_source_reentry_observation.py",
    "tests/test_aura_workcapsule_stale_exact_observation_owner_reduction.py",
    "tests/test_aura_workcapsule_stale_exact_reentry.py",
    "tests/test_aura_workcapsule_two_phase_observation_bound_exact.py",
    "tests/test_aura_workcapsule_two_phase_owner_reduced_transition.py",
    ...
    "tools/aura_review/aura_review_cache_policy.py",
