...
- **elapsed_ms**: 30425.41
- **last_incremental_refresh_unix**: 1784932047
...
- **skipped_dir_file_counts**: `.git`=140, `.ruff_cache`=5, `Aura_Memory`=10, `Aura_Sandbox`=1, `__pycache__`=92
...
- `aura_node.py` (python_module): 80 symbols, degree 890, ~104798 tokens
- `aura_gate.py` (python_module): 68 symbols, degree 756, ~20345 tokens
- `aura_unified_memory_continuity.py` (python_module): 80 symbols, degree 667, ~25839 tokens
