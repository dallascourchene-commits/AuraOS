...
- **file_count**: 1653
- **total_bytes**: 26502023
- **text_tokens_est**: 6615847
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/o7_external_authentication_cutset/README.md",
    "tools/arena/worker_cells/o7_external_authentication_cutset/auth_cutset.py",
    "tools/arena/worker_cells/o7_external_authentication_cutset/campaign.py",
    "tools/arena/worker_cells/o7_external_authentication_cutset/test_auth_cutset.py",
