...
- **file_count**: 982
- **total_bytes**: 50594727
- **text_tokens_est**: 3252601
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 132, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 686, 'schema_or_lexicon': 95, 'support_file': 41}
- **topology_nodes**: 8126
- **topology_edges**: 17719
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 21139.39

## Coverage

- **included_file_count**: 982
...
- ... 814 more; query CODEMAP.json for exact file cards
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 482, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=482 nodes=36 neighbors=`aura_architect_loop.py`, `aura_external_llm_session.py`, `aura_fusion.py`, `aura_graphify_schema.py`
