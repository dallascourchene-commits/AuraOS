...
- **file_count**: 1565
- **total_bytes**: 59062242
- **text_tokens_est**: 5308863
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 64, 'knowledge_artifact': 197, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 978, 'schema_or_lexicon': 230, 'support_file': 80}
...
- ... 1342 more; query CODEMAP.json for exact file cards
...
- `aura_ephemeral_workspace_runtime_v2.py` (python_module): 51 symbols, degree 504, ~15721 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_ephemeral_workspace_runtime_v2.py` degree=504 nodes=52 neighbors=`aura_coding_relationship_compass.py`, `aura_construction_spatial_foundry.py`, `aura_ephemeral_adapter_registry.py`, `aura_ephemeral_registry_store.py`
...
- `AdapterMetadata` -> `aura_ephemeral_adapter_registry.py:69`
