...
- **file_count**: 1651
- **total_bytes**: 26515216
- **text_tokens_est**: 6619157
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1008, 'schema_or_lexicon': 272, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tests/test_bughound_resource_settlement.py",
    ...
    "tools/bughound/resource_settlement.py",
