...
- **file_count**: 1421
- **total_bytes**: 56788085
- **text_tokens_est**: 4744743
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 51, 'knowledge_artifact': 184, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 917, 'schema_or_lexicon': 176, 'support_file': 77}
- **topology_nodes**: 10547
- **topology_edges**: 24927
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 30998.32

## Coverage

- **included_file_count**: 1421
...
- `.aura/analysis/pr199_review_fixes_payload.txt`
- `.aura/arena_routes/coding.v1.json`
- `.aura/arena_routes/construction.v1.json`
- ... 1213 more; query CODEMAP.json for exact file cards
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 557, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=557 nodes=36 neighbors=`aura_architect_loop.py`, `aura_architecture_harness_git_tree_routing.py`, `aura_external_llm_session.py`, `aura_fusion.py`
