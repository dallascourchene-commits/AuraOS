...
- **file_count**: 1661
- **total_bytes**: 26594125
- **text_tokens_est**: 6638889
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1018, 'schema_or_lexicon': 272, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tests/test_bughound_authority_artifact_binding.py",
    "tests/test_bughound_authority_registry_self_validation.py",
