...
- **file_count**: 1285
- **total_bytes**: 54929235
- **text_tokens_est**: 4293619
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 43, 'knowledge_artifact': 162, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 875, 'schema_or_lexicon': 145, 'support_file': 45}
- **topology_nodes**: 10038
- **topology_edges**: 23036
...
- **skipped_dir_file_counts**: `.git`=35, `.pytest_cache`=4, `Aura_Memory`=8, `Aura_Sandbox`=1, `__pycache__`=68
...
- `ArchitectureComponent` -> `aura_coding_relationship_compass.py:43`
