...
- **file_count**: 1725
- **total_bytes**: 27113920
- **text_tokens_est**: 6768857
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1047, 'schema_or_lexicon': 298, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-corroboration-below-host-rank.yml",
    ".github/workflows/aura-workcapsule-exact-hold-to-closed-transition.yml",
    ...
    ".github/workflows/aura-workcapsule-portable-raw-slice-host-plane-separation.yml",
    ".github/workflows/aura-workcapsule-preplan-post-observation-transition.yml",
    ".github/workflows/aura-workcapsule-raw-owner-end-to-end-stale-lifecycle.yml",
    ".github/workflows/aura-workcapsule-raw-owner-hold-to-closed-transition.yml",
    ".github/workflows/aura-workcapsule-raw-slice-host-plane-separation.yml",
    ...
    "scripts/aura_workcapsule_corroboration_below_host_rank.py",
    ...
    "scripts/aura_workcapsule_portable_raw_slice_host_plane_separation.py",
    "scripts/aura_workcapsule_preplan_post_observation_transition.py",
    ...
    "scripts/aura_workcapsule_raw_slice_host_plane_separation.py",
    ...
    "scripts/aura_workcapsule_temporal_host_observation_admission.py",
    ...
    "tests/test_aura_workcapsule_corroboration_below_host_rank.py",
    "tests/test_aura_workcapsule_exact_hold_to_closed_transition.py",
    ...
    "tests/test_aura_workcapsule_portable_raw_slice_host_plane_separation.py",
    "tests/test_aura_workcapsule_preplan_post_observation_transition.py",
    "tests/test_aura_workcapsule_raw_owner_end_to_end_stale_lifecycle.py",
    "tests/test_aura_workcapsule_raw_owner_hold_to_closed_transition.py",
    "tests/test_aura_workcapsule_raw_owner_stale_safe_reentry.py",
    "tests/test_aura_workcapsule_raw_slice_host_plane_separation.py",
    ...
    "tests/test_aura_workcapsule_stale_observation_closure_exact_verifier.py",
    "tests/test_aura_workcapsule_temporal_host_observation_admission.py",
