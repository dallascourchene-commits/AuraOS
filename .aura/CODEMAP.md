...
- **file_count**: 1431
- **total_bytes**: 56947160
- **text_tokens_est**: 4784515
...
- **skipped_dir_file_counts**: `.git`=25, `.pytest_cache`=4, `.ruff_cache`=4, `Aura_Memory`=8, `Aura_Sandbox`=1, `__pycache__`=23
