...
- **file_count**: 1656
- **total_bytes**: 26544061
- **text_tokens_est**: 6626372
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1009, 'schema_or_lexicon': 276, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/glm53-bounded-official-payload-range-manifest.yml",
    ".github/workflows/glm53-live-tensor-concrete-page-producer-admission.yml",
    ".github/workflows/glm53-official-quantization-source-admission.yml",
    ".github/workflows/glm53-official-source-concrete-page-provenance-join.yml",
    ".github/workflows/glm53-official-source-trial-bridge.yml",
    ...
    "tests/test_aura_glm53_bounded_official_payload_range_manifest.py",
    "tests/test_aura_glm53_live_tensor_concrete_page_producer_admission.py",
    ...
    "tools/quantization/aura_glm53_bounded_official_payload_range_manifest.py",
    "tools/quantization/aura_glm53_historical_official_w2_bridge.py",
    "tools/quantization/aura_glm53_live_tensor_concrete_page_producer_admission.py",
    "tools/quantization/aura_glm53_official_source_admission.py",
    "tools/quantization/aura_glm53_official_source_concrete_page_provenance_join.py",
    "tools/quantization/aura_glm53_official_source_trial_bridge.py",
    "tools/quantization/aura_glm53_quantized_representation_trial.py",
    "tools/quantization/test_aura_glm53_official_source_concrete_page_provenance_join.py",
    "tools/quantization/test_aura_glm53_official_source_trial_bridge.py",
