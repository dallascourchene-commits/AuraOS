...
- **file_count**: 1737
- **total_bytes**: 27227202
- **text_tokens_est**: 6797184
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1053, 'schema_or_lexicon': 304, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-artifact-qualified-host-observation.yml",
    ...
    ".github/workflows/aura-workcapsule-corroboration-causal-host-lineage.yml",
    ...
    "scripts/aura_workcapsule_corroboration_causal_host_lineage.py",
    ...
    "tests/test_aura_workcapsule_corroboration_causal_host_lineage.py",
