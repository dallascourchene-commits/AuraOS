...
- **file_count**: 1750
- **total_bytes**: 27366295
- **text_tokens_est**: 6831962
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1065, 'schema_or_lexicon': 305, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-corroboration-qualified-host-member.yml",
    ".github/workflows/aura-workcapsule-current-causal-corroboration-member.yml",
    ...
    "scripts/aura_workcapsule_corroboration_qualified_host_member.py",
    "scripts/aura_workcapsule_current_causal_corroboration_member.py",
    ...
    "tests/test_aura_workcapsule_corroboration_qualified_host_member.py",
    "tests/test_aura_workcapsule_current_causal_corroboration_member.py",
