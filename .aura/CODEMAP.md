...
- **file_count**: 1655
- **total_bytes**: 26573346
- **text_tokens_est**: 6633691
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 238, 'native_accelerator': 16, 'operator_script': 9, 'python_module': 1001, 'schema_or_lexicon': 278, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/k27-astge-source-owned-mmap-exec.yml",
    ...
    "crates/aura-k27-astge-mmap-exec/Cargo.toml",
    "crates/aura-k27-astge-mmap-exec/src/lib.rs",
