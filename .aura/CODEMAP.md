...
- **file_count**: 1644
- **total_bytes**: 26434758
- **text_tokens_est**: 6599043
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 999, 'schema_or_lexicon': 273, 'support_file': 50}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".aura/arena/nav03a-proof-activation-sol2.txt",
    ...
    ".github/workflows/aura-nav03a-hosted-proof-mirror-sol2.yml",
