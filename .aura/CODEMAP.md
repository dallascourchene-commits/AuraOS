...
- **file_count**: 1662
- **total_bytes**: 26625726
- **text_tokens_est**: 6646788
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 238, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1001, 'schema_or_lexicon': 282, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/k27-astge-v4-typed-generation-exec.yml",
    ...
    "crates/aura-k27-astge-v4-typed-exec/Cargo.toml",
    "crates/aura-k27-astge-v4-typed-exec/src/lib.rs",
