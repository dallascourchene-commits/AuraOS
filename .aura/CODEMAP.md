...
- **file_count**: 825
- **total_bytes**: 63721720
- **text_tokens_est**: 6533677
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 111, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 578, 'schema_or_lexicon': 66, 'support_file': 42}
- **topology_nodes**: 7197
- **topology_edges**: 15039
...
- `aura_planning_board.py` (python_module): 51 symbols, degree 284, ~7678 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_planning_board.py` degree=284 nodes=52 neighbors=`aura_event_contracts.py`, `aura_planning_regression.py`
