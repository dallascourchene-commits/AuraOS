...
- **file_count**: 1416
- **total_bytes**: 56675111
- **text_tokens_est**: 4716497
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 51, 'knowledge_artifact': 184, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 915, 'schema_or_lexicon': 174, 'support_file': 76}
- **topology_nodes**: 10494
- **topology_edges**: 24683
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 30603.4

## Coverage

- **included_file_count**: 1416
...
- `!button` -> `aura_showcase/attempt-archive.js:91`, `aura_showcase/crucible.js:289`, `aura_showcase/gate-dialogue.js:196`, `aura_spatial_web/construction_demo_app.js:129`
...
- `!r` -> `.github/scripts/apply_umc_completion.py:11`, `aura_agent_arena_github_bridge.py:180`, `aura_architect_consolidation_benchmark.py:193`, `aura_architect_consolidation_benchmark_v2.py:55`
...
- `!state` -> `aura_showcase/gate-dialogue.js:270`, `aura_spatial_web/construction_demo_app.js:198`
...
- `.github/workflows/unified-memory-completion-apply.yml`
...
- `aura_unified_memory_continuity.py` (python_module): 92 symbols, degree 709, ~25839 tokens
- `aura_agent_arena_cli.py` (python_module): 100 symbols, degree 575, ~17235 tokens
- `aura_fst_routing.py` (python_module): 35 symbols, degree 552, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_unified_memory_continuity.py` degree=709 nodes=93 neighbors=`aura_event_contracts.py`, `aura_unified_memory_continuity_toolchain.py`
  - `aura_agent_arena_cli.py` degree=575 nodes=101 neighbors=`aura_agent_arena_bridge.py`, `aura_agent_arena_fireworks.py`
  - `aura_fst_routing.py` degree=552 nodes=36 neighbors=`aura_architect_loop.py`, `aura_architecture_harness_git_tree_routing.py`, `aura_external_llm_session.py`, `aura_fusion.py`
