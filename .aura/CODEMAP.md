...
- **file_count**: 1717
- **total_bytes**: 27054791
- **text_tokens_est**: 6754073
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1039, 'schema_or_lexicon': 298, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-portable-higher-owner-owner-reduction.yml",
    ".github/workflows/aura-workcapsule-post-repair-portable-higher-owner-continuity.yml",
    ...
    "tests/test_aura_workcapsule_portable_higher_owner_owner_reduction.py",
    "tests/test_aura_workcapsule_post_repair_portable_higher_owner_continuity.py",
