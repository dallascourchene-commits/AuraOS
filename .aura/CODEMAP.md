...
- **file_count**: 1688
- **total_bytes**: 26810952
- **text_tokens_est**: 6693102
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1019, 'schema_or_lexicon': 289, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-owner-bound-reentry-closure.yml",
    ...
    ".github/workflows/aura-workcapsule-source-bound-exact-reentry.yml",
    ...
    "tests/test_aura_workcapsule_owner_bound_reentry_closure.py",
