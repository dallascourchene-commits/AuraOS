...
- **file_count**: 1748
- **total_bytes**: 27340231
- **text_tokens_est**: 6825445
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1063, 'schema_or_lexicon': 305, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-causal-host-memory-evidence.yml",
    ".github/workflows/aura-workcapsule-current-recursive-target-raw-slice.yml",
    ".github/workflows/aura-workcapsule-live-causal-artifact-causal-host-envelope.yml",
    ...
    "scripts/aura_workcapsule_causal_host_memory_evidence.py",
    ...
    "scripts/aura_workcapsule_live_causal_artifact_causal_host_envelope.py",
    ...
    "tests/test_aura_workcapsule_causal_host_memory_evidence.py",
    "tests/test_aura_workcapsule_context_binding.py",
    "tests/test_aura_workcapsule_current_recursive_target_raw_slice_binding.py",
    "tests/test_aura_workcapsule_live_causal_artifact_causal_host_envelope.py",
