...
- **file_count**: 1649
- **total_bytes**: 26503076
- **text_tokens_est**: 6616122
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/glm53-minimum-official-metadata-admission.yml",
    ...
    "tests/test_aura_glm53_minimum_official_metadata_admission.py",
    ...
    "tools/quantization/aura_glm53_minimum_official_metadata_admission.py",
