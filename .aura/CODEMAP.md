...
- **file_count**: 1653
- **total_bytes**: 26507418
- **text_tokens_est**: 6617196
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_05_fused_route_cost_receipt/README.md",
    "tools/arena/worker_cells/agent_05_fused_route_cost_receipt/benchmark_fused_route_cost_receipt.py",
    "tools/arena/worker_cells/agent_05_fused_route_cost_receipt/fused_route_cost_receipt.py",
    "tools/arena/worker_cells/agent_05_fused_route_cost_receipt/test_fused_route_cost_receipt.py",
