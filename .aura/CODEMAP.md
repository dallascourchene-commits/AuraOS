...
- **file_count**: 1376
- **total_bytes**: 56369786
- **text_tokens_est**: 4642813
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 50, 'knowledge_artifact': 179, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 908, 'schema_or_lexicon': 172, 'support_file': 52}
...
- `!CONSTRUCTION_REPRESENTATION_MODES` -> `aura_spatial_web/construction_scene_renderer.js:327`
...
- `!Number` -> `.github/workflows/aura-construction-g7-g8-review-repair.yml:87`, `aura_spatial_web/construction_mesh_pass.js:15`, `aura_spatial_web/construction_overlay_pass.js:26`, `aura_spatial_web/construction_scene_renderer.js:29`
...
- `!buffer` -> `aura_spatial_web/webgl2_gaussian_pass.js:236`, `aura_spatial_web/webgl2_renderer.js:195`
- `!button` -> `aura_showcase/attempt-archive.js:91`, `aura_showcase/crucible.js:289`, `aura_showcase/gate-dialogue.js:196`, `aura_spatial_web/construction_demo_app.js:128`
...
- `!entity` -> `aura_spatial_web/construction_demo_app.js:205`, `aura_spatial_web/construction_scene_renderer.js:447`
...
- `!frame` -> `aura_spatial_web/construction_scene_renderer.js:145`
...
- `!gl` -> `.github/workflows/aura-construction-g7-g8-review-repair.yml:100`, `aura_spatial_web/webgl2_gaussian_pass.js:200`, `aura_spatial_web/webgl2_renderer.js:168`
...
- `!innerGaussianPass` -> `aura_spatial_web/construction_scene_renderer.js:619`
- `!input` -> `aura_showcase/app.js:270`, `aura_spatial_web/construction_demo_app.js:139`
...
- `!program` -> `.github/workflows/aura-construction-g7-g8-review-repair.yml:100`, `aura_spatial_web/webgl2_gaussian_pass.js:217`
...
- `!response` -> `aura_human_agent_arena/construction.js:18`, `aura_spatial_web/bootstrap.js:26`, `aura_spatial_web/construction_demo_app.js:393`
...
- `!shader` -> `aura_spatial_web/webgl2_gaussian_pass.js:197`, `aura_spatial_web/webgl2_renderer.js:165`
...
- `!state` -> `.github/workflows/aura-construction-g7-g8-review-repair.yml:123`, `aura_showcase/gate-dialogue.js:270`, `aura_spatial_web/construction_demo_app.js:197`
- `!statement` -> `aura_showcase/civic.js:303`
- `!status` -> `AURA_FINAL_REPORT.md:136`, `SYNTAX_FIXES_APPLIED.md:107`, `aura_node.py:5239`
- `!steps` -> `.github/workflows/aura-construction-g7-g8-review-repair.yml:123`, `aura_spatial_web/construction_demo_app.js:325`
- `!strategy_buffer_stats` -> `aura_coordinated_solver.py:69`, `aura_node.py:7548`
- `!supported` -> `.github/workflows/aura-construction-g7-g8-honesty-v2.yml:42`, `.github/workflows/aura-construction-g7-g8-honesty.yml:46`
...
- `!this` -> `.github/workflows/aura-construction-g7-g8-review-repair-v3.yml:75`, `.github/workflows/aura-construction-g7-g8-review-repair.yml:73`, `aura_spatial_web/construction_mesh_pass.js:175`, `aura_spatial_web/construction_overlay_pass.js:118`
...
- ... 1188 more; query CODEMAP.json for exact file cards
...
- `aura_relational_index.py` (python_module): 75 symbols, degree 461, ~25891 tokens
