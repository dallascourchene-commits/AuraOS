...
- **file_count**: 1685
- **total_bytes**: 26776941
- **text_tokens_est**: 6684599
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1017, 'schema_or_lexicon': 288, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-raw-owner-stale-safe-exact-reentry.yml",
    ...
    "scripts/aura_workcapsule_raw_owner_stale_safe_exact_reentry.py",
    ...
    "tests/test_aura_workcapsule_raw_owner_stale_safe_exact_reentry.py",
