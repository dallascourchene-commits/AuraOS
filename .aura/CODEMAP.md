...
- **file_count**: 1721
- **total_bytes**: 27071363
- **text_tokens_est**: 6758216
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-causal-raw-slice-host-separation.yml",
    ...
    "scripts/aura_workcapsule_causal_raw_slice_host_separation.py",
    ...
    "tests/test_aura_workcapsule_causal_raw_slice_host_separation.py",
