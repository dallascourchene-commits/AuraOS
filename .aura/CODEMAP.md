...
- **file_count**: 1554
- **total_bytes**: 58777964
- **text_tokens_est**: 5237790
...
- **topology_nodes**: 11298
- **topology_edges**: 27375
...
- `aura_ephemeral_workspace_contracts.py` (python_module): 86 symbols, degree 628, ~25347 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_ephemeral_workspace_contracts.py` degree=628 nodes=87 neighbors=`aura_coding_relationship_compass.py`, `aura_ephemeral_path_policy.py`, `aura_llm_egress.py`, `aura_spatial_projection.py`
