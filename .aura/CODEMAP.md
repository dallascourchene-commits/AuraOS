...
- **file_count**: 1702
- **total_bytes**: 26709472
- **text_tokens_est**: 6667729
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 240, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1035, 'schema_or_lexicon': 289, 'support_file': 53}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/project006-o23-exact-ms-time-repair.yml",
    ".github/workflows/project006-o23-runtime-activation-proof.yml",
    ...
    "artifacts/arena/project006_o23_runtime_activation/PROOF_RECEIPT_O23.json",
    "arxiv_forager.py",
    "async_palace.py",
    "aura.lexc",
    ...
    "tests/test_project006_runtime_activation_o23.py",
    ...
    "tools/project006/o23_reference/proof_o23.py",
    ...
    "tools/project006/test_physical_wake_acceptance.py",
