...
- **file_count**: 1653
- **total_bytes**: 26519281
- **text_tokens_est**: 6620161
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_08_efficiency_proof_reuse_gate/README.md",
    "tools/arena/worker_cells/agent_08_efficiency_proof_reuse_gate/campaign.py",
    "tools/arena/worker_cells/agent_08_efficiency_proof_reuse_gate/efficiency_proof_reuse_gate.py",
    "tools/arena/worker_cells/agent_08_efficiency_proof_reuse_gate/test_efficiency_proof_reuse_gate.py",
