...
- **file_count**: 1653
- **total_bytes**: 26508149
- **text_tokens_est**: 6617372
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_06_workload_contamination_gate/README.md",
    "tools/arena/worker_cells/agent_06_workload_contamination_gate/campaign.py",
    "tools/arena/worker_cells/agent_06_workload_contamination_gate/test_workload_contamination_gate.py",
    "tools/arena/worker_cells/agent_06_workload_contamination_gate/workload_contamination_gate.py",
