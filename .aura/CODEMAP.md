...
- **file_count**: 1699
- **total_bytes**: 26902564
- **text_tokens_est**: 6716010
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1029, 'schema_or_lexicon': 290, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-fully-raw-temporal-transition-v2.yml",
    ...
    ".github/workflows/aura-workcapsule-stale-observation-closure-exact-verifier.yml",
    ...
    "scripts/aura_workcapsule_fully_raw_temporal_transition_v2.py",
    ...
    "tests/test_aura_workcapsule_fully_raw_temporal_transition_v2.py",
