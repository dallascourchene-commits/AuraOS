...
- **file_count**: 1533
- **total_bytes**: 58455657
- **text_tokens_est**: 5157764
...
- `!ackResponse` -> `aura_showcase/construction-foundry-director.js:429`
...
- `!capResponse` -> `aura_showcase/construction-foundry-director.js:274`
- `!capResult` -> `aura_showcase/construction-foundry-director.js:274`
...
- `!chapter` -> `aura_showcase/construction-foundry-director.js:170`
...
- `!confirmResponse` -> `aura_showcase/construction-foundry-director.js:407`
- `!confirmResult` -> `aura_showcase/construction-foundry-director.js:407`
...
- `!manifest` -> `AURA_FINAL_REPORT.md:138`, `aura_node.py:7740`, `aura_showcase/construction-foundry-director.js:193`, `aura_showcase/pascal-workbench/pascal-workbench.js:557`
...
- `!prepareResponse` -> `aura_showcase/construction-foundry-director.js:336`
- `!prepareResult` -> `aura_showcase/construction-foundry-director.js:336`
...
- `!projectResponse` -> `aura_showcase/construction-foundry-director.js:361`
- `!projectResult` -> `aura_showcase/construction-foundry-director.js:361`
- `!projection` -> `aura_showcase/construction-decision-foundry.js:242`, `aura_showcase/construction-foundry-director.js:100`
...
- `!response` -> `aura_human_agent_arena/construction.js:18`, `aura_showcase/construction-decision-as-built-sync.js:223`, `aura_showcase/construction-decision-foundry.js:107`, `aura_showcase/construction-foundry-director.js:117`
...
- `!root` -> `aura_showcase/construction-decision-foundry.js:5`, `aura_showcase/construction-foundry-director.js:79`, `aura_showcase/pascal-construction-foundry.js:5`
...
- `!session` -> `aura_showcase/construction-foundry-director.js:193`, `aura_showcase/pascal-construction-foundry.js:121`
...
- `!target` -> `aura_coding_arena/main.js:143`, `aura_human_agent_arena/main.js:441`, `aura_showcase/construction-foundry-director.js:150`, `aura_showcase/gate-dialogue.js:575`
...
- ... 1310 more; query CODEMAP.json for exact file cards
...
- `aura_spatial_contracts.py` (python_module): 74 symbols, degree 513, ~16200 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_spatial_contracts.py` degree=513 nodes=75 neighbors=`aura_construction_demo_director.py`, `aura_construction_demo_projection.py`, `aura_construction_foundry_decision.py`, `aura_event_contracts.py`
