...
- **skipped_dir_file_counts**: `.git`=179, `Aura_Memory`=6, `Aura_Sandbox`=1, `__pycache__`=8
...
- `!Number` -> `aura_spatial_web/construction_mesh_pass.js:15`, `aura_spatial_web/construction_overlay_pass.js:26`, `aura_spatial_web/construction_scene_renderer.js:29`, `aura_spatial_web/construction_wireframe_pass.js:15`
...
- `!String` -> `aura_showcase/attempt-archive.js:187`, `aura_showcase/gate-dialogue.js:341`, `aura_showcase/human.js:657`
...
- `!answer` -> `aura_showcase/gate-dialogue.js:433`
...
- `!button` -> `aura_showcase/attempt-archive.js:91`, `aura_showcase/crucible.js:289`, `aura_showcase/gate-dialogue.js:200`, `aura_spatial_web/construction_demo_app.js:129`
...
- `!comment` -> `aura_showcase/gate-dialogue.js:390`
...
- `!decision` -> `aura_showcase/gate-dialogue.js:281`
- `!dialogue` -> `aura_showcase/gate-dialogue.js:37`
- `!diff` -> `aura_showcase/gate-dialogue.js:527`
...
- `!entity` -> `aura_spatial_web/construction_demo_app.js:206`, `aura_spatial_web/construction_scene_renderer.js:447`
...
- `!hasEvidence` -> `aura_showcase/gate-dialogue.js:517`, `aura_showcase/human.js:460`
...
- `!installPanel` -> `aura_showcase/attempt-archive.js:127`, `aura_showcase/gate-dialogue.js:319`
...
- `!node` -> `aura_human_agent_arena/emergent.js:37`, `aura_showcase/gate-dialogue.js:227`, `aura_showcase/intent.js:346`, `aura_showcase/topology.js:128`
...
- `!rows` -> `aura_showcase/gate-dialogue.js:246`
...
- `!selected` -> `aura_coding_arena/main.js:91`, `aura_showcase/gate-dialogue.js:85`
...
- `!stageState` -> `aura_showcase/gate-dialogue.js:566`
...
- `!state` -> `aura_showcase/gate-dialogue.js:345`, `aura_spatial_web/construction_demo_app.js:198`
...
- `!target` -> `aura_coding_arena/main.js:143`, `aura_human_agent_arena/main.js:441`, `aura_showcase/gate-dialogue.js:565`, `aura_showcase/human.js:672`
- `!target_bytes` -> `cognitive_search.rs:72`
- `!task` -> `aura_showcase/gate-dialogue.js:58`, `aura_showcase/human.js:282`, `aura_showcase/topology.js:101`
...
- `!tool` -> `aura_showcase/gate-dialogue.js:179`
...
- `!value` -> `aura_showcase/app.js:223`, `aura_showcase/gate-dialogue.js:367`, `aura_spatial_web/construction_overlay_pass.js:71`, `aura_spatial_web/interaction_adapter.js:37`
...
- `.aura/refactor_objectives/bilateral_intent_guardrail_foundry_pr2_revision.v1.json`
...
- `aura_crypto_puf.py`
- ... 25 more; query CODEMAP.json for exact file cards
...
- `aura_intent_refinement.py` (python_module): 63 symbols, degree 466, ~13598 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_unified_memory_continuity.py` degree=725 nodes=93 neighbors=`aura_bilateral_intent_canonical.py`, `aura_event_contracts.py`, `aura_unified_memory_continuity_learning.py`, `aura_unified_memory_continuity_toolchain.py`
  ...
  - `aura_intent_refinement.py` degree=466 nodes=64 neighbors=`aura_arena_gate_dialogue.py`, `aura_bilateral_intent_canonical.py`, `aura_bilateral_intent_ingestion.py`, `aura_event_contracts.py`
