...
- **file_count**: 1642
- **total_bytes**: 26453226
- **text_tokens_est**: 6603659
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-adopt-zf04.yml",
    ...
    "tools/aura_adopt/aura_distribution_trust.py",
    "tools/aura_adopt/test_aura_distribution_trust.py",
