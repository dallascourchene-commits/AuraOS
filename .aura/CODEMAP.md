...
- **file_count**: 1653
- **total_bytes**: 26499807
- **text_tokens_est**: 6615292
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_13_generation_aware_security_reproof/README.md",
    "tools/arena/worker_cells/agent_13_generation_aware_security_reproof/campaign.py",
    "tools/arena/worker_cells/agent_13_generation_aware_security_reproof/generation_aware_security_reproof.py",
    "tools/arena/worker_cells/agent_13_generation_aware_security_reproof/test_generation_aware_security_reproof.py",
