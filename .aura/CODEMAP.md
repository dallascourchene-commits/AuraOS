...
- **file_count**: 1635
- **total_bytes**: 26343310
- **text_tokens_est**: 6576244
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 234, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 996, 'schema_or_lexicon': 271, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "aura_llm_egress.py",
    "aura_local_inference_gateway.py",
