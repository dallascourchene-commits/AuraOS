...
- **file_count**: 1654
- **total_bytes**: 26537639
- **text_tokens_est**: 6624763
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 15, 'operator_script': 9, 'python_module': 1001, 'schema_or_lexicon': 277, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-k27-astge-mmap-generation.yml",
    ...
    "crates/aura-k27-astge-mmap/tests/mmap_generation_contract.rs",
