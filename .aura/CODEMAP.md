...
- **file_count**: 1648
- **total_bytes**: 26476626
- **text_tokens_est**: 6609512
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 238, 'native_accelerator': 16, 'operator_script': 9, 'python_module': 997, 'schema_or_lexicon': 275, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/k27-astge-generation-store.yml",
    ".github/workflows/k27-astge-storage-kernel.yml",
    ...
    "crates/aura-k27-astge/clippy.toml",
    "crates/aura-k27-astge/src/coord.rs",
    "crates/aura-k27-astge/src/generation.rs",
    "crates/aura-k27-astge/src/lib.rs",
    "crates/aura-k27-astge/src/storage.rs",
    "dag_executor.py",
    "dag_executor.rs",
    "debug_att.py",
