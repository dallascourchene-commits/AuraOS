...
- **file_count**: 1696
- **total_bytes**: 26675139
- **text_tokens_est**: 6659143
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "artifacts/arena/project006_o22_effect_time_loaded_execution/PROOF_RECEIPT_O22.json",
    "arxiv_forager.py",
    "async_palace.py",
    "aura.lexc",
    ...
    "tests/test_project006_effect_time_loaded_execution_o22.py",
    ...
    "tools/project006/effect_time_loaded_execution.py",
