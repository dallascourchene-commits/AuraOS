...
- **file_count**: 1714
- **total_bytes**: 27024851
- **text_tokens_est**: 6746587
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1037, 'schema_or_lexicon': 297, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-portable-higher-owner-closed-lifecycle.yml",
    ...
    "scripts/aura_workcapsule_portable_higher_owner_closed_lifecycle.py",
    ...
    "tests/test_aura_workcapsule_portable_higher_owner_closed_lifecycle.py",
