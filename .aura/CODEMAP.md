...
- **file_count**: 1643
- **total_bytes**: 26435759
- **text_tokens_est**: 6599291
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-lifecycle-router.yml",
    ...
    "05_staging/aura_lifecycle_router/README.md",
    "05_staging/aura_lifecycle_router/lifecycle_router.py",
    "05_staging/aura_lifecycle_router/test_lifecycle_router.py",
