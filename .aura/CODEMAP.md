...
- **file_count**: 1643
- **total_bytes**: 26475860
- **text_tokens_est**: 6609317
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1000, 'schema_or_lexicon': 272, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-adopt-pck2-owner-resolved-kv.yml",
    ...
    "tools/aura_adopt/owner_resolved_persistent_kv_reuse.py",
    "tools/aura_adopt/test_owner_resolved_persistent_kv_reuse.py",
    "tools/aura_adopt/test_pck2_current_proof_head.py",
