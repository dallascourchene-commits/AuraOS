...
- **file_count**: 1653
- **total_bytes**: 26511682
- **text_tokens_est**: 6618261
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_01_cache_policy_adjudicator/README.md",
    "tools/arena/worker_cells/agent_01_cache_policy_adjudicator/benchmark_cache_policy_adjudicator.py",
    "tools/arena/worker_cells/agent_01_cache_policy_adjudicator/cache_policy_adjudicator.py",
    "tools/arena/worker_cells/agent_01_cache_policy_adjudicator/test_cache_policy_adjudicator.py",
