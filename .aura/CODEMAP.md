...
- **file_count**: 907
- **total_bytes**: 65913870
- **text_tokens_est**: 7082425
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 122, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 640, 'schema_or_lexicon': 76, 'support_file': 41}
- **topology_nodes**: 7748
- **topology_edges**: 16753
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 23522.0

## Coverage

- **included_file_count**: 907
...
- ... 3 more; query CODEMAP.json for exact file cards
...
- ... 758 more; query CODEMAP.json for exact file cards
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 464, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=464 nodes=36 neighbors=`aura_architect_loop.py`, `aura_fusion.py`, `aura_graphify_schema.py`, `aura_harness_evolver.py`
