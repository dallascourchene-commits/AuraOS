...
- **file_count**: 1451
- **total_bytes**: 57402401
- **text_tokens_est**: 4895528
...
- `!CONSTRUCTION_REPRESENTATION_MODES` -> `aura_spatial_web/construction_scene_renderer.js:560`
...
- `!base` -> `aura_spatial_web/construction_scene_renderer.js:692`
...
- `!current` -> `aura_spatial_web/construction_scene_renderer.js:692`
...
- `!entity` -> `aura_spatial_web/construction_demo_app.js:206`, `aura_spatial_web/construction_scene_renderer.js:745`
- `!entityId` -> `aura_spatial_web/construction_scene_renderer.js:761`
...
- `!failure` -> `aura_spatial_web/construction_scene_renderer.js:1008`
...
- `!force` -> `aura_spatial_web/construction_scene_renderer.js:982`, `aura_spatial_web/gaussian_renderer.js:566`
...
- `!innerGaussianPass` -> `aura_spatial_web/construction_scene_renderer.js:1090`
...
- `!receipt` -> `aura_spatial_web/app.js:112`, `aura_spatial_web/construction_scene_renderer.js:497`
...
- `!this` -> `aura_spatial_web/construction_mesh_pass.js:175`, `aura_spatial_web/construction_overlay_pass.js:118`, `aura_spatial_web/construction_scene_renderer.js:516`, `aura_spatial_web/gaussian_renderer.js:758`
