...
- **file_count**: 1665
- **total_bytes**: 26595877
- **text_tokens_est**: 6639327
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 20, 'operator_script': 9, 'python_module': 1003, 'schema_or_lexicon': 281, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-k27-astge-current-module-symbols.yml",
    ...
    "crates/aura-k27-astge-symbols/tests/current_stack_symbol_persistence.rs",
