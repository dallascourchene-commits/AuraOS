...
- **file_count**: 1652
- **total_bytes**: 26500425
- **text_tokens_est**: 6615449
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tests/test_frontier27_owner_epoch_adapter.py",
    ...
    "tools/arena/campaign_frontier27_owner_epoch.py",
    "tools/arena/consequence_admission_kernel.py",
    "tools/arena/frontier27_owner_epoch_adapter.py",
