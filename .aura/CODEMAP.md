...
- **file_count**: 1481
- **total_bytes**: 57816456
- **text_tokens_est**: 4998998
...
- **topology_nodes**: 10939
- **topology_edges**: 26297
...
- **skipped_dir_file_counts**: `.git`=200, `Aura_Memory`=6, `Aura_Sandbox`=1, `__pycache__`=8
...
- `!hasOwn` -> `aura_showcase/construction-spatial-foundry.js:173`
