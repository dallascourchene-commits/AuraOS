...
- **file_count**: 1649
- **total_bytes**: 26495883
- **text_tokens_est**: 6614325
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1004, 'schema_or_lexicon': 274, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/glm53-official-source-c2-request-admission.yml",
    ".github/workflows/glm53-owner-host-source-header-materializer.yml",
    ...
    "tests/test_glm53_owner_host_source_header_materializer.py",
    ...
    "tools/quantization/aura_glm53_owner_host_source_header_materializer.py",
