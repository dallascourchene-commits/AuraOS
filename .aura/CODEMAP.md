...
- **file_count**: 1712
- **total_bytes**: 26992063
- **text_tokens_est**: 6738389
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1037, 'schema_or_lexicon': 295, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-fully-raw-owner-hold-to-closed-transition.yml",
    ".github/workflows/aura-workcapsule-o31-positive-diagnostic.yml",
    ...
    "scripts/aura_workcapsule_fully_raw_owner_hold_to_closed_transition.py",
    "scripts/aura_workcapsule_observation_bound_closure.py",
    "scripts/aura_workcapsule_observation_bound_exact_verifier.py",
    "scripts/aura_workcapsule_owner_bound_reentry_closure.py",
    ...
    "tests/test_aura_workcapsule_fully_raw_owner_hold_to_closed_transition.py",
