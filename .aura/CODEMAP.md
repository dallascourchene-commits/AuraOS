...
- **file_count**: 1662
- **total_bytes**: 26605629
- **text_tokens_est**: 6641765
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 18, 'operator_script': 9, 'python_module': 1001, 'schema_or_lexicon': 282, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-k27-astge-mmap-capability-convergence.yml",
    ...
    ".github/workflows/k27-astge-generation-domain.yml",
    ...
    "crates/aura-k27-astge-canonical-backend/Cargo.toml",
    "crates/aura-k27-astge-canonical-backend/src/lib.rs",
