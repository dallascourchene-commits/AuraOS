...
- **file_count**: 1551
- **total_bytes**: 25762958
- **text_tokens_est**: 6431440
- **role_counts**: {'interface_surface': 65, 'knowledge_artifact': 202, 'native_accelerator': 8, 'operator_script': 6, 'python_module': 983, 'schema_or_lexicon': 238, 'support_file': 49}
...
```json
{
  ...
  "paths": [
    ...
    "aura_spatial_web/multimodal_locator_adapter.js",
