...
- **file_count**: 1649
- **total_bytes**: 26478529
- **text_tokens_est**: 6609985
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 238, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1003, 'schema_or_lexicon': 274, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/glm53-rope-polar-kv-reference.yml",
    ...
    "tools/quantization/aura_rope_polar_kv_reference.py",
    ...
    "tools/quantization/test_aura_rope_polar_kv_reference.py",
