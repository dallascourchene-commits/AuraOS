...
- **file_count**: 1653
- **total_bytes**: 26510765
- **text_tokens_est**: 6618033
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/gpt56sol_runtime_bound_shared_memory_o2/README.md",
    "tools/arena/worker_cells/gpt56sol_runtime_bound_shared_memory_o2/campaign.py",
    "tools/arena/worker_cells/gpt56sol_runtime_bound_shared_memory_o2/runtime_bound_memory.py",
    "tools/arena/worker_cells/gpt56sol_runtime_bound_shared_memory_o2/tests/test_runtime_bound_memory.py",
