...
- **file_count**: 1695
- **total_bytes**: 26876914
- **text_tokens_est**: 6709596
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1025, 'schema_or_lexicon': 290, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-canonical-stale-lifecycle.yml",
    ...
    "scripts/aura_workcapsule_canonical_stale_lifecycle.py",
    ...
    "tests/test_aura_workcapsule_canonical_stale_lifecycle.py",
