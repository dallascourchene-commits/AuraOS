...
- **file_count**: 1642
- **total_bytes**: 26440100
- **text_tokens_est**: 6600377
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/spatial-viewpoint-phase-steering.yml",
    ...
    "tests/test_spatial_viewpoint_phase_steering.py",
    ...
    "tools/spatial/viewpoint_phase_steering_witness.py",
