...
- **file_count**: 194
- **total_bytes**: 16536
- **text_tokens_est**: 856360
- **role_counts**: {'binary_artifact': 11, 'interface_surface': 1, 'knowledge_artifact': 28, 'native_accelerator': 6, 'operator_script': 4, 'python_module': 122, 'schema_or_lexicon': 9, 'support_file': 13}
- **topology_nodes**: 0
- **topology_edges**: 0
- **topology_source**: disabled
- **elapsed_ms**: 7610.86
- **last_incremental_refresh_unix**: 1782271961
...
- **skipped_dir_file_counts**: `.git`=44, `.pytest_cache`=4, `Aura_Memory`=1, `__pycache__`=15
...
- `!ar_server_start` -> `USER_GUIDE.md:345`, `aura_node.py:6185`
- `!ar_server_stop` -> `USER_GUIDE.md:346`, `aura_node.py:6201`
- `!ar_start` -> `AURA_FINAL_REPORT.md:168`, `USER_GUIDE.md:345`, `aura_node.py:6185`, `refactored-auraos-upgrades.md:2572`
- `!ar_stop` -> `AURA_FINAL_REPORT.md:169`, `USER_GUIDE.md:346`, `aura_node.py:6201`, `refactored-auraos-upgrades.md:2572`
- `!attention` -> `USER_GUIDE.md:185`, `aura_node.py:5476`
- `!audit` -> `USER_GUIDE.md:200`, `aura_node.py:5980`
- `!backtrack` -> `AURA_FINAL_REPORT.md:143`, `README.md:79`, `USER_GUIDE.md:277`, `arxiv_forager.py:599`
- `!benchmark` -> `README.md:26`, `USER_GUIDE.md:199`, `aura_node.py:2982`, `daily_digest_2026-06-06.md:14`
- `!c` -> `arch_reasoner_accel.rs:14`
- `!calibrate` -> `AURA_FINAL_REPORT.md:163`, `README.md:78`, `USER_GUIDE.md:220`, `aura_node.py:7046`
...
- `!crystallize` -> `AURA_FINAL_REPORT.md:141`, `USER_GUIDE.md:284`, `aura_node.py:6820`
- `!curiosity_tree` -> `AURA_FINAL_REPORT.md:174`, `USER_GUIDE.md:280`, `aura_node.py:6242`
- `!db_repair` -> `USER_GUIDE.md:349`, `aura_node.py:2982`
- `!evolve_reasoning` -> `AURA_FINAL_REPORT.md:157`, `USER_GUIDE.md:194`, `aura_node.py:6815`
- `!export` -> `USER_GUIDE.md:347`, `aura_node.py:5803`
- `!fast_path` -> `AURA_FINAL_REPORT.md:173`, `USER_GUIDE.md:183`, `aura_node.py:6905`, `test_aura_functions.py:900`
- `!forage` -> `USER_GUIDE.md:276`, `aura_node.py:5986`, `refactored-auraos-upgrades.md:2573`
- `!forage_off` -> `USER_GUIDE.md:282`, `aura_node.py:6179`
- `!forage_on` -> `USER_GUIDE.md:281`, `aura_node.py:6173`
- `!forager_off` -> `USER_GUIDE.md:282`, `aura_node.py:6179`
- `!forager_on` -> `USER_GUIDE.md:281`, `aura_node.py:6173`
...
- `!indus_decrypt` -> `AURA_FINAL_REPORT.md:175`, `USER_GUIDE.md:286`, `aura_node.py:6827`
- `!manifest` -> `AURA_FINAL_REPORT.md:138`, `USER_GUIDE.md:166`, `aura_node.py:7171`
- `!markov` -> `AURA_FINAL_REPORT.md:144`, `USER_GUIDE.md:350`, `aura_node.py:7018`
- `!mesh_status` -> `AURA_FINAL_REPORT.md:167`, `USER_GUIDE.md:344`, `aura_node.py:5439`
...
- `!ping_mesh` -> `AURA_FINAL_REPORT.md:166`, `USER_GUIDE.md:343`, `aura_node.py:5434`
- `!plan` -> `aura_node.py:5377`
- `!push` -> `USER_GUIDE.md:348`, `aura_node.py:5090`, `test_aura_functions.py:208`
...
- `!repair_db` -> `USER_GUIDE.md:349`, `aura_node.py:6493`
- `!research` -> `AURA_FINAL_REPORT.md:142`, `README.md:80`, `USER_GUIDE.md:278`, `aura_node.py:6012`
- `!review` -> `USER_GUIDE.md:210`, `aura_node.py:6306`, `mistral_gate.py:78`
- `!rollback` -> `USER_GUIDE.md:214`, `aura_node.py:6291`
- `!route` -> `AURA_FINAL_REPORT.md:28`, `AURA_ROUTER.md:213`, `README.md:81`, `USER_GUIDE.md:221`
...
- `!search_similar` -> `USER_GUIDE.md:279`, `aura_node.py:6215`, `refactored-auraos-upgrades.md:2573`
...
- `!settings` -> `README.md:75`, `USER_GUIDE.md:166`, `aura_node.py:7171`, `daily_digest_2026-06-06.md:14`
...
- `!synthesize` -> `USER_GUIDE.md:285`, `aura_associative_core.py:138`, `aura_node.py:6410`, `test_aura_functions.py:886`
...
- `!timeline` -> `USER_GUIDE.md:283`, `aura_node.py:6254`
- `!topology` -> `AURA_FINAL_REPORT.md:48`, `README.md:76`, `USER_GUIDE.md:179`, `aura_ai_router.py:143`
- `!topology_deep` -> `USER_GUIDE.md:180`, `aura_node.py:6745`
- `!total` -> `aura_savings_dashboard.py:224`
- `!voice` -> `USER_GUIDE.md:351`, `aura_node.py:7227`
