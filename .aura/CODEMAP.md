...
- **file_count**: 1302
- **total_bytes**: 55314332
- **text_tokens_est**: 4389806
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 43, 'knowledge_artifact': 164, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 881, 'schema_or_lexicon': 153, 'support_file': 46}
- **topology_nodes**: 10189
- **topology_edges**: 23510
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 22582.37

## Coverage

- **included_file_count**: 1302
...
- ... 1124 more; query CODEMAP.json for exact file cards
...
- `aura_relational_index.py` (python_module): 75 symbols, degree 457, ~25069 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_relational_index.py` degree=457 nodes=80 neighbors=`aura_capability_connectome.py`, `aura_capability_connectome_v2.py`, `aura_codebase_navigator.py`, `aura_coding_relationship_compass.py`
...
- `AbilityAtom` -> `aura_emergent_potential_repl.py:174`
...
- `ArchitectureComponent` -> `aura_coding_relationship_compass.py:149`
