...
- **file_count**: 1710
- **total_bytes**: 26978805
- **text_tokens_est**: 6735074
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1036, 'schema_or_lexicon': 294, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-raw-owner-derived-post-closure-transition.yml",
    ...
    "tests/test_aura_workcapsule_raw_owner_derived_post_closure_transition.py",
