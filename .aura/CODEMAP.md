...
- **file_count**: 1074
- **total_bytes**: 51578632
- **text_tokens_est**: 3536898
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 27, 'knowledge_artifact': 141, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 742, 'schema_or_lexicon': 107, 'support_file': 42}
- **topology_nodes**: 8677
- **topology_edges**: 19129
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 495, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=495 nodes=36 neighbors=`aura_architect_loop.py`, `aura_external_llm_session.py`, `aura_fusion.py`, `aura_graphify_schema.py`
