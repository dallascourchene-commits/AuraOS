...
- **file_count**: 825
- **total_bytes**: 63774939
- **text_tokens_est**: 6547674
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 111, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 579, 'schema_or_lexicon': 66, 'support_file': 41}
- **topology_nodes**: 7216
- **topology_edges**: 15080
- **topology_source**: compiled_deep_topology
- **elapsed_ms**: 19432.86

## Coverage

- **included_file_count**: 825
...
- **skipped_dir_file_counts**: `.git`=51, `Aura_Memory`=1, `Aura_Sandbox`=1, `__pycache__`=8
...
- ... 685 more; query CODEMAP.json for exact file cards
...
- `aura_live_architect.py` (python_module): 74 symbols, degree 540, ~30294 tokens
- `test_scientific_memory.py` (python_module): 111 symbols, degree 517, ~13607 tokens
- `aura_relational_authority.py` (python_module): 58 symbols, degree 483, ~19006 tokens
...
- `aura_planning_board.py` (python_module): 51 symbols, degree 285, ~7678 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_live_architect.py` degree=540 nodes=85 neighbors=`aura_architect_loop.py`, `aura_builder_context.py`, `aura_coding_arena_grounding.py`, `aura_coding_arena_workflow.py`
  ...
  - `aura_relational_authority.py` degree=483 nodes=59 neighbors=`aura_graphify_schema.py`, `aura_live_architect.py`, `aura_workflow_gates.py`, `liquid_attractor_control_plane.py`
  ...
  - `aura_planning_board.py` degree=285 nodes=52 neighbors=`aura_event_contracts.py`, `aura_planning_frontier.py`, `aura_planning_regression.py`
