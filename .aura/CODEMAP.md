...
- **file_count**: 1642
- **total_bytes**: 26431721
- **text_tokens_est**: 6598282
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-adopt-zf00.yml",
    ...
    "tools/aura_adopt/aura_adoption_bootstrap.py",
    "tools/aura_adopt/test_aura_adoption_bootstrap.py",
