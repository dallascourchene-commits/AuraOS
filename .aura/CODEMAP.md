...
- **file_count**: 1721
- **total_bytes**: 27068674
- **text_tokens_est**: 6757545
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1044, 'schema_or_lexicon': 297, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-causal-raw-slice-host-plane-separation.yml",
    ...
    "scripts/aura_workcapsule_causal_raw_slice_host_plane_separation.py",
    ...
    "tests/test_aura_workcapsule_causal_raw_slice_host_plane_separation.py",
