...
- **file_count**: 1451
- **total_bytes**: 58236066
- **text_tokens_est**: 4891130
...
- **skipped_dir_file_counts**: `Aura_Memory`=6, `Aura_Sandbox`=1, `__pycache__`=8
...
- `!CONSTRUCTION_REPRESENTATION_MODES` -> `aura_spatial_web/construction_scene_renderer.js:463`
...
- `!base` -> `aura_spatial_web/construction_scene_renderer.js:589`
...
- `!current` -> `aura_spatial_web/construction_scene_renderer.js:589`
...
- `!entity` -> `aura_spatial_web/construction_demo_app.js:206`, `aura_spatial_web/construction_scene_renderer.js:642`
- `!entityId` -> `aura_spatial_web/construction_scene_renderer.js:657`
...
- `!innerGaussianPass` -> `aura_spatial_web/construction_scene_renderer.js:923`
...
- `!presentationRenderer` -> `aura_spatial_web/app.js:112`, `aura_spatial_web/construction_scene_renderer.js:234`, `aura_spatial_web/gaussian_renderer.js:432`
...
- `!receipt` -> `aura_spatial_web/app.js:112`, `aura_spatial_web/construction_scene_renderer.js:402`
...
- `!this` -> `aura_spatial_web/construction_mesh_pass.js:175`, `aura_spatial_web/construction_overlay_pass.js:118`, `aura_spatial_web/construction_scene_renderer.js:421`, `aura_spatial_web/gaussian_renderer.js:757`
