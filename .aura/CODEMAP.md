...
- **file_count**: 817
- **total_bytes**: 63637547
- **text_tokens_est**: 6513324
...
- `aura_planning_board.py` (python_module): 51 symbols, degree 281, ~7452 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_planning_board.py` degree=281 nodes=52 neighbors=`aura_event_contracts.py`
