...
- **file_count**: 1145
- **total_bytes**: 54017995
- **text_tokens_est**: 3975435
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 29, 'knowledge_artifact': 152, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 794, 'schema_or_lexicon': 124, 'support_file': 31}
- **topology_nodes**: 9461
...
- **skipped_dir_file_counts**: `.git`=30, `.pytest_cache`=5, `.ruff_cache`=4, `Aura_Memory`=39, `Aura_Sandbox`=1, `__pycache__`=488
...
- `!forage` -> `aura_affordance_directory.py:503`, `aura_capability_lane_registry.py:120`, `aura_node.py:6190`, `refactored-auraos-upgrades.md:2573`
...
- ... 972 more; query CODEMAP.json for exact file cards
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 518, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=518 nodes=36 neighbors=`aura_architect_loop.py`, `aura_external_llm_session.py`, `aura_fusion.py`, `aura_gate.py`
