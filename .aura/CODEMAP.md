...
- **file_count**: 977
- **total_bytes**: 50555119
- **text_tokens_est**: 3242696
- **role_counts**: {'binary_artifact': 2, 'interface_surface': 13, 'knowledge_artifact': 132, 'native_accelerator': 8, 'operator_script': 5, 'python_module': 681, 'schema_or_lexicon': 95, 'support_file': 41}
- **topology_nodes**: 8077
...
- ... 8 more; query CODEMAP.json for exact file cards
...
- `aura_fst_routing.py` (python_module): 35 symbols, degree 481, ~8991 tokens
...
- **top_files_by_degree**:
  ...
  - `aura_fst_routing.py` degree=481 nodes=36 neighbors=`aura_architect_loop.py`, `aura_external_llm_session.py`, `aura_fusion.py`, `aura_graphify_schema.py`
