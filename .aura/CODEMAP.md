...
- **file_count**: 1653
- **total_bytes**: 26513103
- **text_tokens_est**: 6618615
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/gpt56sol_evidence_slice_dag/README.md",
    "tools/arena/worker_cells/gpt56sol_evidence_slice_dag/campaign.py",
    "tools/arena/worker_cells/gpt56sol_evidence_slice_dag/evidence_slice_dag.py",
    "tools/arena/worker_cells/gpt56sol_evidence_slice_dag/test_evidence_slice_dag.py",
