...
- **file_count**: 1653
- **total_bytes**: 26515054
- **text_tokens_est**: 6619104
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tools/arena/worker_cells/agent_01_generation_reproof_certificate/README.md",
    "tools/arena/worker_cells/agent_01_generation_reproof_certificate/campaign.py",
    "tools/arena/worker_cells/agent_01_generation_reproof_certificate/generation_reproof_certificate.py",
    "tools/arena/worker_cells/agent_01_generation_reproof_certificate/test_generation_reproof_certificate.py",
