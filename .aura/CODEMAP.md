...
- **file_count**: 1669
- **total_bytes**: 26675710
- **text_tokens_est**: 6659287
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 237, 'native_accelerator': 12, 'operator_script': 9, 'python_module': 1026, 'schema_or_lexicon': 272, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    "tests/test_bughound_four_leaf_human_review.py",
    "tests/test_bughound_four_leaf_human_review_repro_owner_currentness.py",
    ...
    "tools/bughound/four_leaf_human_review.py",
