...
- **file_count**: 1723
- **total_bytes**: 27103834
- **text_tokens_est**: 6766335
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 20, 'operator_script': 9, 'python_module': 1045, 'schema_or_lexicon': 297, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-causal-temporal-host-observation.yml",
    ".github/workflows/aura-workcapsule-exact-hold-to-closed-transition.yml",
    ".github/workflows/aura-workcapsule-live-causal-raw-slice-host.yml",
    ...
    "index.html",
    "integration/o38_live_causal_raw_slice_probe.rs",
    ...
    "scripts/aura_workcapsule_causal_temporal_host_observation_admission.py",
    "scripts/aura_workcapsule_context_binding.py",
    "scripts/aura_workcapsule_exact_hold_to_closed_transition.py",
    "scripts/aura_workcapsule_live_causal_raw_slice_host.py",
    ...
    "scripts/aura_workcapsule_same_live_causal_world_host.py",
    ...
    "tests/test_aura_workcapsule_causal_temporal_host_observation_admission.py",
    "tests/test_aura_workcapsule_context_binding.py",
    "tests/test_aura_workcapsule_exact_hold_to_closed_transition.py",
    "tests/test_aura_workcapsule_live_causal_raw_slice_host.py",
...
```json
{
  ...
  "roles": {
    ...
    "native_accelerator": 20,
    "operator_script": 9,
    "python_module": 1045,
    "schema_or_lexicon": 297,
    "support_file": 49
  }
}
```
