...
- **file_count**: 1726
- **total_bytes**: 27129127
- **text_tokens_est**: 6772660
- **role_counts**: {'interface_surface': 64, 'knowledge_artifact': 239, 'native_accelerator': 19, 'operator_script': 9, 'python_module': 1047, 'schema_or_lexicon': 299, 'support_file': 49}
...
```json
{
  ...
  "all_included_paths_sorted": [
    ...
    ".github/workflows/aura-workcapsule-portable-derived-scoped-rebind.yml",
    ".github/workflows/aura-workcapsule-post-repair-source-projection-continuity.yml",
    ".github/workflows/aura-workcapsule-post-source-portable-higher-owner-continuity.yml",
    ...
    ".github/workflows/aura-workcapsule-shared-target-owner-reduction.yml",
    ...
    "tests/test_aura_workcapsule_post_world_bound_scoped_rebind.py",
    ...
    "tests/test_aura_workcapsule_shared_target_owner_reduction.py",
