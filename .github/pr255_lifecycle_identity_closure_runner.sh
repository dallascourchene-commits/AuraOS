...
test ! -e .github/workflows/pr255-lifecycle-identity-closure.yml
test ! -e .github/pr255_lifecycle_identity_closure_patch.py
test ! -e .github/pr255_lifecycle_identity_closure_runner.sh
