...
def test_materialize_verified_patch(record_property) -> None:
    module = _patch_module(Path("aura_relational_synthesis.py").read_text(encoding="utf-8"))
    tests = _patch_tests(
    ...
    record_property("aura_relational_synthesis_py_b64", base64.b64encode(module.encode()).decode())
    record_property("test_aura_relational_synthesis_py_b64", base64.b64encode(tests.encode()).decode())
