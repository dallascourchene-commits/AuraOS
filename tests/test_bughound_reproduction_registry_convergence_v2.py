...
class ReproductionRegistryConvergenceV2Tests(unittest.TestCase):
    ...
    def test_one_valid_match_plus_malformed_neighbor_poison_full_registry_binding(self):
        ...
        # Resolver can identify the one exact active match, but the admission also
        # binds the complete source-owned registry. The malformed neighbor must
        # therefore fail structural registry validation instead of being hidden.
