...
def t(receipt,reproof=('C',),transition='T',horizon=0,future=None):return TypedClosureCertificate(TypedClosureDisposition.READY,None,hx('typed-'+receipt),hx('infl-'+receipt),reproof,horizon,transition,future,receipt)
