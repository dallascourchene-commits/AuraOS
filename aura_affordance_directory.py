...
# ---------------------------------------------------------------------------
# Seed affordances (canonical built-in capability set)
# ---------------------------------------------------------------------------
...
SEED_AFFORDANCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "related_affordances": ["aura.agent_arena.bridge", "aura.coding_arena.capsule_compiler", "aura.coding.relationship_compass"],
    ...
    },
    {
        ...
        "related_affordances": ["aura.coding_arena.topology", "aura.concept_workspace", "aura.agent_arena.bridge", "aura.emergent_potential.audit", "aura.coding_waboose.learning", "aura.relational.synthesis", "aura.relationship.atlas", "aura.coding.relationship_compass"],
    ...
    {
        "id": "aura.relational.synthesis",
        "name": "Relational Synthesis Capsule Compiler",
        "description": "Compiles an exact, objective-scoped JIT relational capsule from an Emergent Evidence Spine packet and a six-slot intent packet without granting patch authority.",
        "status": "active",
        "tags": ["relational", "synthesis", "jit", "capsule", "objective", "evidence", "intent", "shadow"],
        "when_to_use": "When an exact repository objective needs a bounded temporary configuration of participants, source slices, tests, and authority boundaries after AOT anatomy lookup.",
        "when_not_to_use": "When source evidence or inventory digests are missing, or when a persisted global relationship map is required. Use Relational Index or Relationship Atlas instead.",
        "implemented_by": ["aura_relational_synthesis.py"],
        "symbols": ["compile_relational_shadow_capsule", "RelationalSynthesisCapsule"],
        "tests": ["tests/test_aura_relational_synthesis.py"],
        "docs": ["docs/AURA_RELATIONAL_SYNTHESIS_REFACTOR_PLAN.md"],
        "commands": [],
        "requires": ["aura.relational.index", "aura.emergent_potential.audit", "six-slot intent packet"],
        "outputs": ["relational_synthesis_capsule", "participants", "groups", "source_slices", "tests", "boundary"],
        "related_affordances": ["aura.relational.index", "aura.relationship.atlas", "aura.coding.relationship_compass", "aura.architect_loop"],
        "safety": "Shadow/proposal-only capsule. Exact packet digests and repository identity are required. No patch, execution, commit, push, PR, or merge authority.",
        "patch_authority": False,
        "vsa_patch_authority": False,
        "prompt_card": "Use Relational Synthesis after exact grounding to compile a bounded JIT configuration for one objective; never treat the capsule as authorization.",
    },
    {
        "id": "aura.relationship.atlas",
        "name": "Architecture Relationship Atlas",
        "description": "Classifies what current architectural relationships mean across eight orthogonal dimensions, preserving exact wiring, candidates, missing roles, and prohibited combinations.",
        "status": "active",
        "tags": ["atlas", "relationship", "architecture", "classification", "prohibition", "motif", "missing_role", "projection"],
        "when_to_use": "When coding work needs to distinguish exact wiring, overlap, auxiliary relations, candidates, missing configurations, and relationships that must not be wired.",
        "when_not_to_use": "When asking what atomic functions exist or when mutation authority is required. Use CodeTopo/Relational Index for anatomy and exact source spans for patch authority.",
        "implemented_by": ["aura_relationship_atlas.py"],
        "symbols": ["build_relationship_atlas", "load_relationship_atlas", "compile_atlas_projection", "relationships_for_participant", "validate_relationship_atlas"],
        "tests": ["tests/test_aura_relationship_atlas.py", "tests/test_aura_coding_relationship_compass.py"],
        "docs": ["docs/AURA_ARCHITECTURE_RELATIONSHIP_ATLAS.md"],
        "commands": ["python -m aura_relationship_atlas build --profile MINIMAL", "python -m aura_relationship_atlas validate"],
        "requires": ["aura.relational.index", "Capability Connectome V2", "current repository identity"],
        "outputs": ["relationship_assessments", "missing_configurations", "prohibitions", "bounded_projection", "delta_receipt"],
        "related_affordances": ["aura.relational.index", "aura.relational.synthesis", "aura.emergent_potential.audit", "aura.coding.relationship_compass"],
        "safety": "Compiled advisory intelligence plane only. Candidate relationships cannot self-promote; prohibitions and canonical truth owners remain binding.",
        "patch_authority": False,
        "vsa_patch_authority": False,
        "prompt_card": "Use Relationship Atlas to understand what relationships mean, what must be preserved, what is missing, and what must not be wired.",
    },
    {
        "id": "aura.coding.relationship_compass",
        "name": "Coding Relationship Compass",
        "description": "Combines Connectome capability selection, exact Emergent Evidence Spine grounding, JIT Relational Synthesis, and objective-bounded Atlas intelligence into one Architect/Surgeon coding packet.",
        "status": "active",
